...
# Servir archivos subidos (avatares, comprobantes, imágenes de premios) en desarrollo.
# En producción esto lo debe hacer el servidor web (Nginx/Apache/WhiteNoise).
if settings.DEBUG:
